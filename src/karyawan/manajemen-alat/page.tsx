...
export default function ManajemenAlatPage() {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
        ...
        const allReports: TruckChecklistReport[] = checklistsSnapshot.docs.map(doc => doc.data() as TruckChecklistReport);
        const todaysReports = allReports.filter(r => r.id.includes(todayStr) && r.location === user.location);
